...
## If you have not upgraded your Attack Speed item to the end of the Murder Forest, this upgrade will be useless for you. Wings are simply the next upgrade to your attackspeed item after that zone is completed.
...
## Purchase your desired wing number from the "Attack Wing Shop" and use the create command with your attack speed item. If you wish to try on the wings you can try them on for free from the "Preview Wings" shops in the bottom left corner of this area. You will have to take off your attackspeed item to try on the preview wings as they use the same slot.
