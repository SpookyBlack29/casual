## Casual RPG Tier Guide created by SpookyBlack with help from iFailz
...
After you have reached 200k stats you must decide if you want to keep your base character model or choose a skin. The available skins for each class can be seen here: https://cafe.naver.com/casualrpg it should be the fifth pinned thread down but if not just translate the page and look where it says something about skins. For the second tier you will not be able to choose a skin yet, but if you wish to pick a skin later you will need to use the correct tiering item.
...
To choose which skin you want you will need unifont and to look at the page with the skins I linked further up in the guide. All you have to do is kill boars and get the upgrade material with the same name as the skin you want. Look for matching korean letters.
